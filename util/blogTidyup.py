...
OLD_LINKS = [
    {
        ...
        "pattern": r"\(/memex/blog/research/current-research-projects/\)",
        "replace": r"(/memex/blog/current-research-projects/)"
    },
    {
...
#        quit()
        ...
        postMemexPath = f"/memex/blog{postXmlData['link'].replace(CURRENT_BLOG_URL, '')}"
...
#        pageData['content'] = cleanupContent(pageData['content'])
        ...
        pageMemexPath = f"/memex/blog{pageXmlData['link'].replace(CURRENT_BLOG_URL, '')}"
