...
def extractFrontMatter( file ):
    ...
    #with mkdocs_gen_files.open(file, "r") as f:
...
def getPlantData():
    ...
    #print(f"{DOCS_FOLDER}/{INDIVIDUAL_PLANTS_FOLDER}/*.md")
#    logger.debug(f"{INDIVIDUAL_PLANTS_FOLDER}/*.md")
    files = glob.glob(f"{DOCS_FOLDER}/{INDIVIDUAL_PLANTS_FOLDER}/*.md")
...
""")
        ...
        #mkdocs_gen_files.set_edit_path(f"{INDIVIDUAL_PLANTS_FOLDER}/plant-gps.js", "plantLocation.py")



print("------ 1 before getPlantData ")
plantData = getPlantData()
print("------ 2 after getPlantData ")
generatePlantJS(plantData)
print("------ 3 after generatePlantJS ")