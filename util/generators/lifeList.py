...
A list of all the bird photos taken from the observations listed in my [[bird-life-list]].
...
[//begin]: # "Autogenerated by lifeList.py"
[birding]: birding "Birding"
[life-list-generator]: ../../colophon/life-list-generator "Life list generator"
    ...
    with mkdocs_gen_files.open(LIFE_LIST_PAGE, "w") as f:
        ...
        for bird in birds:
            ...
            for row in birdRows.iterrows():
                ...
                if camelCaseName not in birdsAdded:
                    birdsAdded[camelCaseName] = True
                    if row[1]['images'] is not None:
                        linkDefs += f"[{camelCaseName}]: {camelCaseName} \"{commonName}\"\n"
    ...
    with mkdocs_gen_files.open(GALLERY_PAGE, "w") as f:
        ...
        for row in rows.iterrows():
            ...
            for image in row[1]['images']:
                ...
                # imgUrl is in form https://<host>/assets/memex/sense/birdwatching/images/<birdName>/<submissionId>.jpg
                # extract the birdName from the imgUrl
                birdName = imgUrl.split("/")[-2]
                if birdName not in birdsAdded:
                    birdsAdded[birdName] = True
                    linkDefs += f"[{commonName}]: {birdName} \"{commonName}\"\n"
...
""")
        ...
        linkDefs += "[//end]: # \"Autogenerated link references\"\n"
        f.write(linkDefs)
