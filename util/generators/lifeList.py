...
A list of the birds I've officially recorded using [eBird](https://ebird.org). Click on the table's column headers to sort the data via that column. See the [[life-list-gallery]] for a list of all the bird photos generated by the observations from this list. See [[life-list-generator]] for how this was done.
