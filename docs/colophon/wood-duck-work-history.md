...
A [[computational-components]] (example of [[gather-weave-augment]]) which takes individual records of work on [[wood-duck-meadows]] into region specific lists. For example, see [[gatton-creek-frontage|Gatton Creek frontage's work history]]
