...
type: plant
---
With succulent, shiny leaves not unlike [[anredera-cordifolia]] this native of the Americas was initially confused with [[anredera-cordifolia]] (when small). The plant has tuberous roots and produces panicles of pink flowers (hence the alternate name _pink baby's breath_). It has a long orange root that can be up to 80cm long.
...
{{ observations( { "subject": "talinum-paniculatum" } ) }}
