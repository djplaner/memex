...
More explicitly, Kennedy et al. (2014) position learning analytics at the intersection between learning design and technological tools. Echoing standard advice prevalent since about that time that learning analytics be designed to serve the purposes/needs of a specific learning design. How explicitly learning analytics support specific learning designs is questionable, especially given default learning analytics functionality of very general tools like a LMS or some of the common enterprise approaches to learning analytics.
...
Kennedy, G., Corrin, L., Lockyer, L., Dawson, S., Williams, D., Mulder, R., Khamis, S., & Copeland, S. (2014). Completing the loop: Returning learning analytics to teachers. *Rhetoric and Reality: Critical Perspectives on Educational Technology. Proceedings Ascilite Dunedin 2014*, 436--440.
