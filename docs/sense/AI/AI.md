...
!!! note "Informed by a skeptical perspective and little detailed engagement"

	__Disclaimer__: I'm skeptical of LLMs (see below). I've made almost no direct use of LLMs, though engage somewhat through CoPilot and "AI" identification tools in services like iNaturalist. I read/listen occasionally to various takes on LLMs.
...
My initial and current taken on LLMs is that they are over-blown, useful but over-blown. Likely to be widely used badly and generate negative consequences due to broken societal/commercial systems and bad actors. Actors that either leverage the inherent limitations of LLMs for immediate gain, or focus on "hiding" the limitations. 
...
[the-algorithm-everyone-thinks-they-understand]: the-algorithm-everyone-thinks-they-understand "The algorithm everyone thinks they understand"
