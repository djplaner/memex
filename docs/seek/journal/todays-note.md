...
- working on [[wood-duck-observations]]
  - Update [[bird-life-list]] to ensure that graph and backlinks working
      - How to merge inaturalist and eBird data
      - Create life list that merges both and has linkdefs
      - Add linkdefs to the species and observations pages created
