...
- Design a "latest change" generator that summarises major changes to the site on a page 

  - Perhaps reading git data to know what to include/exclude
- Develop a generator (or other method) for providing an online visualisation of the structure
- Move my blog from Word press into memex
- Move memex to the djon.es domain
- Re-design the home page for djon.es
  - alt/visible descriptions for images
  - rework the personal description
    - Bricoleur re-entangling relationships between purpose, context, pedagogy and technology
