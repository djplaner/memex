...
[[life-list]] as part of broader [[wood-duck-observations]] work

- add detail of each observation to life list table, including link to individual observations
- add `image:` frontmatter to each observation - first image from observation
- start thinking iNaturalist
...
[life-list]: ../../sense/Observations/life-list "Bird observations"
