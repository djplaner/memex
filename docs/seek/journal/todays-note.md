...
Currently working on adding observationIndex macro to display birds ([[bird-observations]]). At the stage of needing to write a method, but also asking the question whether or not the code should be separated out of the macro file.
...
[bird-observations]: ../../sense/Observations/bird-observations/bird-observations "Bird observations"
