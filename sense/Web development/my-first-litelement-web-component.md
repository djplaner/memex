...
Leaps straight into publishing the content into npm.  I'm wondering if there's an interim stage here?
...
e.g. ```import calendar from '../calendar.js'``` would result in a variable named calendar with the information. That appears like it might work.
